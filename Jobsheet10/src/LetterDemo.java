        ...
        do {
            ...
            switch (choice) {
                case 1:
                    ...
                    ExcuseLetter4 ltr = new ExcuseLetter4(id, name, className, type, duration);
                    stack.push(ltr);
                    System.out.printf("%s's letter has been successfully submitted\n", ltr.name);
                    break;
                
                case 2:
                    ExcuseLetter4 verified = stack.pop();
                    if (verified != null) {
                ...
                case 4:
                    ...
                    ExcuseLetter4 searched = stack.searchLetter(searchName);
                    if (searched != null) {
